...
class WildBody:
    def __init__(self, ID):
        ...
        self.ID = ID
        self.x = random.randint(int(0.2*width), int(0.5*width))
...
def start_collision(arbiter, space, data):
    ...
    print("Elapsed Time = ", pygame.time.get_ticks())
    return True


def log_collision(s1, s2, data, val):
    ...
    # writer.writerow(body.position)
    # writer.writerow(pygame.time.get_ticks())  # remove from start_collision
    return True
